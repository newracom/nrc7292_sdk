...
int hostapd_set_freq(struct hostapd_data *hapd, enum hostapd_hw_mode mode,
			 ...
			 int vht_enabled,
		     int he_enabled, int s1g_enabled,
		     ...
		     int center_segment0, int center_segment1)
{
	...
	if (hostapd_set_freq_params(&data, mode, freq, freq_fractional,
				    channel, ht_enabled, vht_enabled, he_enabled, s1g_enabled,
					sec_channel_offset,
				    oper_chwidth,
			  ...
			  int center_segment0, int center_segment1)
{
	...
	if (hostapd_set_freq_params(&data, mode, freq, 0, channel,
				    ht_enabled, vht_enabled, he_enabled, 0, sec_channel_offset,
