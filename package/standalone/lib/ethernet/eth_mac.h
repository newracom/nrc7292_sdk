...
struct esp_eth_mac_s {
    ...
    *
    */
    nrc_err_t (*set_mediator)(esp_eth_mac_t *mac, esp_eth_mediator_t *eth);
    ...
    *      - NRC_ERR_TIMEOUT: initialize Ethernet MAC failed because of timeout
    *      - ESP_FAIL: initialize Ethernet MAC failed because some other error occurred
    *
    */
    nrc_err_t (*init)(esp_eth_mac_t *mac);
    ...
    *
    */
    nrc_err_t (*deinit)(esp_eth_mac_t *mac);
    ...
    *
    */
    nrc_err_t (*start)(esp_eth_mac_t *mac);
    ...
    *
    */
    nrc_err_t (*stop)(esp_eth_mac_t *mac);
    ...
    *
    */
    nrc_err_t (*transmit)(esp_eth_mac_t *mac, uint8_t *buf, uint32_t length);
    ...
    *
    */
    nrc_err_t (*receive)(esp_eth_mac_t *mac, uint8_t *buf, uint32_t *length);
    ...
    *      - NRC_ERR_TIMEOUT: read PHY register failed because of timeout
    *      - ESP_FAIL: read PHY register failed because some other error occurred
    *
    */
    nrc_err_t (*read_phy_reg)(esp_eth_mac_t *mac, uint32_t phy_addr, uint32_t phy_reg, uint32_t *reg_value);
    ...
    *
    */
    nrc_err_t (*write_phy_reg)(esp_eth_mac_t *mac, uint32_t phy_addr, uint32_t phy_reg, uint32_t reg_value);
    ...
    *
    */
    nrc_err_t (*set_addr)(esp_eth_mac_t *mac, uint8_t *addr);
    ...
    *
    */
    nrc_err_t (*get_addr)(esp_eth_mac_t *mac, uint8_t *addr);
    ...
    *
    */
    nrc_err_t (*set_speed)(esp_eth_mac_t *mac, eth_speed_t speed);
    ...
    *
    */
    nrc_err_t (*set_duplex)(esp_eth_mac_t *mac, eth_duplex_t duplex);
    ...
    *
    */
    nrc_err_t (*set_link)(esp_eth_mac_t *mac, eth_link_t link);
    ...
    *
    */
    nrc_err_t (*set_promiscuous)(esp_eth_mac_t *mac, bool enable);
    ...
    *
    */
    nrc_err_t (*enable_flow_ctrl)(esp_eth_mac_t *mac, bool enable);
    ...
    */
    nrc_err_t (*set_peer_pause_ability)(esp_eth_mac_t *mac, uint32_t ability);
    ...
    *
    */
    nrc_err_t (*del)(esp_eth_mac_t *mac);
};
