...
struct esp_eth_phy_s {
    ...
    *
    */
    nrc_err_t (*set_mediator)(esp_eth_phy_t *phy, esp_eth_mediator_t *mediator);
    ...
    *
    */
    nrc_err_t (*reset)(esp_eth_phy_t *phy);
    ...
    *
    */
    nrc_err_t (*reset_hw)(esp_eth_phy_t *phy);
    ...
    *
    */
    nrc_err_t (*init)(esp_eth_phy_t *phy);
    ...
    *
    */
    nrc_err_t (*deinit)(esp_eth_phy_t *phy);
    ...
    *
    */
    nrc_err_t (*negotiate)(esp_eth_phy_t *phy);
    ...
    *
    */
    nrc_err_t (*get_link)(esp_eth_phy_t *phy);
    ...
    *
    */
    nrc_err_t (*pwrctl)(esp_eth_phy_t *phy, bool enable);
    ...
    *
    */
    nrc_err_t (*set_addr)(esp_eth_phy_t *phy, uint32_t addr);
    ...
    *
    */
    nrc_err_t (*get_addr)(esp_eth_phy_t *phy, uint32_t *addr);
    ...
    *
    */
    nrc_err_t (*advertise_pause_ability)(esp_eth_phy_t *phy, uint32_t ability);
    ...
    *
    */
    nrc_err_t (*del)(esp_eth_phy_t *phy);
};
