...
typedef struct {
    ...
    */
    ...
    /**
    * @brief Callback function invoked when ethernet link connection is made.
    *
    * @param[in] eth_handle: handle of Ethernet driver
    *
    * @return
    *       - ESP_OK: process ethernet connection handler successfully
    *       - ESP_FAIL: error occurred when processing link up handler
    */
	nrc_err_t (*on_linkup)(esp_eth_handle_t eth_handle);

    /**
    * @brief Callback function invoked when ethernet link lost.
    *
    * @param[in] eth_handle: handle of Ethernet driver
    *
    * @return
    *       - ESP_OK: process ethernet connection lost
    *       - ESP_FAIL: error occurred when processing ethernet lost connection
    */
