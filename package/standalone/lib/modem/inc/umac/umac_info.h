...
void set_umac_stainfo_key_info(int8_t vif_id, uint16_t aid, enum key_type key_type, uint8_t key_id, uint32_t *key);
void clear_umac_stainfo_key_info(int8_t vif_id, uint16_t aid, enum key_type key_type, uint8_t key_id);
