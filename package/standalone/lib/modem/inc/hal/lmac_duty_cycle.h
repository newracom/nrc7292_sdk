...
bool lmac_duty_cycle_schedule(int vif_id, uint16_t sched_duration, int acq, bool is_mgmt);
void lmac_check_duty_window();
void lmac_check_pause_time(uint8_t acq, bool mgmt);
...
bool lmac_duty_is_on( void );
uint32_t lmac_duty_get_token( void );
bool lmac_set_duty_beacon(int vif_id, uint32_t interval, bool is_short_bcn);
#else
static inline void lmac_duty_cycle_init() {return;};
static inline bool lmac_duty_cycle_schedule(int vif_id, uint16_t s, int a, bool i) {return true;};
static inline void lmac_check_duty_window() {return;};
static inline void lmac_check_pause_time(uint8_t acq, bool mgmt) {};
...
static inline bool lmac_set_duty_beacon(int vif_id, uint32_t interval, bool is_short_bcn) {return 0;};
