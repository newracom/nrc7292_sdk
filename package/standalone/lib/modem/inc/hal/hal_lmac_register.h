...
enum {
    ...
    MAC_REG_TX_CONTROL_PARAMETER_RESP_WAIT = MAC_REG_TX_CONTROL_PARAMETER,
    MAC_REG_TX_CONTROL_PARAMETER_RESP_WAIT_SHIFT = 0,
    MAC_REG_TX_CONTROL_PARAMETER_RESP_WAIT_MASK = 0x000000ff,
    ...
    MAC_REG_UL_DATA_IN_WAIT			= MAC_REG_UL_BASE_START + MAC_REG_SIZE * 19,								//0x4008_01c8
    
    MAC_REG_UL_DATA_IN_WAIT_OFFLINE_SECURITY 		= MAC_REG_UL_DATA_IN_WAIT,
    MAC_REG_UL_DATA_IN_WAIT_OFFLINE_SECURITY_SHIFT	= 31,
    MAC_REG_UL_DATA_IN_WAIT_OFFLINE_SECURITY_MASK	= 0x80000000,
    
    
    MAC_REG_PHY_TXFIFO_MAX_DEPTH	= MAC_REG_UL_BASE_START + MAC_REG_SIZE * 20,								//0x4008_01cc
    
    MAC_REG_UL_TXNAV_VALUE 				=	MAC_REG_UL_BASE_START + MAC_REG_SIZE * 21,							//0x4008_01d0
    ...
    MAC_REG_DL_DATA_IN_WAIT		= MAC_REG_DL_BASE_START + MAC_REG_SIZE * 35,							//0x4008_0314
    MAC_REG_DL_DATA_IN_WAIT_OFFLINE_SECURITY 		= MAC_REG_DL_DATA_IN_WAIT,
    MAC_REG_DL_DATA_IN_WAIT_OFFLINE_SECURITY_SHIFT	= 31,
    MAC_REG_DL_DATA_IN_WAIT_OFFLINE_SECURITY_MASK	= 0x80000000,
