					...
					union {
						struct {
							...
							*/							
							...
							uint32_t		reserved: 2;
							*/							
						} STRUCT_PACKED twt_setup;
						struct {
							uint8_t		twt_flow_id: 3;
							uint8_t		reserved: 5;
						} STRUCT_PACKED twt_teardown;
						struct {
							uint8_t		twt_flow_id: 3;
							uint8_t		resp_requested: 1;
							uint8_t		next_twt_req: 1;
							uint8_t		next_twt_subfield_size: 2;
							uint8_t		reserved: 1;
							uint64_t	next_twt;
						} STRUCT_PACKED twt_info;
					} u;
				} STRUCT_PACKED s1g_action;
...
struct ieee80211_s1g_capabilities {
	u8 ht_capabilities_info[10];
	u8 s1g_suppported_mcs_nss_set[5];
} STRUCT_PACKED;
...
/* S1G defines */
/* First octet of HT Operation Information within HT Operation element */
#define S1G_INFO_S1G_LONG_SUPPORT 					((u8) BIT(0))
#define S1G_INFO_SHORT_GI_FOR_1MHZ 					((u8) BIT(1))
#define S1G_INFO_SHORT_GI_FOR_2MHZ 					((u8) BIT(2))
#define S1G_INFO_SHORT_GI_FOR_4MHZ 					((u8) BIT(3))
#define S1G_INFO_SHORT_GI_FOR_8MHZ 					((u8) BIT(4))
#define S1G_INFO_SHORT_GI_FOR_16MHZ 				((u8) BIT(5))
#define S1G_INFO_SUPPORTED_CHANNEL_WIDTH 			((u8) (BIT(6) | BIT(7)))

#define S1G_INFO_RX_LDPC 							((u8) BIT(0))
#define S1G_INFO_TX_STBC 							((u8) BIT(1))
#define S1G_INFO_RX_STBC 							((u8) BIT(2))
#define S1G_INFO_SU_BEAMFORMER_CAPABLE 				((u8) BIT(3))
#define S1G_INFO_SU_BEAMFORMEE_CAPABLE 				((u8) BIT(4))
#define S1G_INFO_BEAMFORMEE_STS_CAPABILITY 			((u8) (BIT(5) | BIT(6) | BIT(7)))

#define S1G_INFO_NUMBER_OF_SOUND_DIMENSION 			((u8) (BIT(1) | BIT(2) | BIT(3)))
/* B4..B7 - Reserved */

#define S1G_OPER_PRI_CHANWIDTH		BIT(0)
#define S1G_OPER_CHANWIDTH_2MHZ		BIT(1)
#define S1G_OPER_CHANWIDTH_4MHZ		BIT(2)
#define S1G_OPER_CHANWIDTH_8MHZ		BIT(3)
#define S1G_OPER_CHANWIDTH_16MHZ	BIT(4)
#define S1G_OPER_1MHZ_PRICHAN_LOC	BIT(5)
#define S1G_OPER_MCS10				BIT(7)

#define CHANWIDTH_1MHZ		1
#define CHANWIDTH_2MHZ		2
#define CHANWIDTH_4MHZ		4
#define CHANWIDTH_8MHZ		8
