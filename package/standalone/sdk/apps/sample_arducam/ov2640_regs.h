...
#define ARDUCHIP_TEST1       	0x00  //SPI Write/Read Test Register
#define ARDUCHIP_MODE      		0x02  //Mode Register Address (Set to value 0x00)

#define ARDUCHIP_FIFO      		0x04  //FIFO Control Address
#define FIFO_CLEAR_MASK    		0x01  //FIFO Control Value (CLEAR FIFO)
#define FIFO_START_MASK    		0x02  //FIFO Control Value (START CAPTURE)
