...
// Get from console
// =================================================
#define AWS_IOT_MQTT_HOST              "a20xb3xwwe6pi-ats.iot.ap-northeast-2.amazonaws.com" ///< Customer specific MQTT HOST. The same will be used for Thing Shadow
#define AWS_IOT_MQTT_PORT              8883 ///< default port for MQTT/S
#define AWS_IOT_MQTT_CLIENT_ID         "NRC_Test" ///< MQTT client ID should be unique for every device
#define AWS_IOT_MY_THING_NAME 		   "NRC_Test" ///< Thing Name of the Shadow this device is associated with
//#define AWS_IOT_ROOT_CA_FILENAME       "RootCA.crt" ///< Root CA file name
//#define AWS_IOT_CERTIFICATE_FILENAME   "f7cb6044e5-certificate.pem.crt" ///< device signed certificate file name
//#define AWS_IOT_PRIVATE_KEY_FILENAME   "f7cb6044e5-private.pem.key" ///< Device private key filename
// =================================================
