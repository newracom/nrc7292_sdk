...
enum {
    ...
    MAC_REG_DL_DATA_IN_WAIT_SECURITY_OFFLINE 		= MAC_REG_DL_DATA_IN_WAIT,
    MAC_REG_DL_DATA_IN_WAIT_SECURITY_OFFLINE_SHIFT	= 31,
    MAC_REG_DL_DATA_IN_WAIT_SECURITY_OFFLINE_MASK	= 0x80000000,
