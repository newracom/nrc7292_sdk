...
public:
    ...
    virtual nvs_err_t read(size_t src_offset, void* dst, size_t size) = 0;

    virtual nvs_err_t write(size_t dst_offset, const void* src, size_t size) = 0;

    virtual nvs_err_t erase_range(size_t dst_offset, size_t size) = 0;
